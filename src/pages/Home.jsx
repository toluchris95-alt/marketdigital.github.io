        ...
        <>
          ...
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md mb-8 grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
            <input
              type="text"
              placeholder="Search..."
              className="w-full px-4 py-2 border rounded-lg col-span-1 dark:bg-gray-700 dark:border-gray-600"
            ...
            <div className="flex items-center space-x-4 col-span-1">
              ...
              <select
                id="category"
                className="form-select rounded-lg dark:bg-gray-700 dark:border-gray-600"
